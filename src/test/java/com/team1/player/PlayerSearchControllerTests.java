...
public class PlayerSearchControllerTests {
	 ...
	 public void test01_getListAll(){
		 String html = rest.getForObject("/player/list", String.class);
		 System.out.println(html);
	 }
	 
	 @Test
		public void test02_getPage() {
			String html = rest.getForObject("/player/page/1", String.class);
			System.out.println(html);
		}
	 @Test
		public void test03_getPlayerByPlayerno() {
			String html = rest.getForObject("/player/item/1",String.class);
			System.out.println(html);
		}
