...
<body>
<!-- <input type="button" id="list" value="231"> -->
<!-- <input type="button" id="list2" value="list2"> -->
	  ...
	  <div class="container-fluid">
		    <ul class="nav navbar-nav nav2">
			      ...
			      <li><a href="#" id="clear" class="btn btn-default btn-sm">clear <span class="glyphicon glyphicon-trash"></span></a></li>
			       <li><a href="#" id="how" class="btn btn-default btn-sm">추가 <span class="glyphicon glyphicon-trash"></span></a></li>
		    </ul>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-10 list1">
				...
				<div id="summernote">${note.noteContent}</div>
			</div>
			<div class="col-lg-2 list2">
				<table id="panel" class="table table-striped" style="color:  #19376A; " > 
					<c:forEach var="n" items="${notes}"> 
					<fmt:formatDate value="${n.noteDate}" pattern="yyyy-MM-dd" var="date" /> 					
							<tr>
								<td colspan="3">${date}</td> 
							</tr>
							<tr onclick="location.href='/note/list/${n.noteNo}'" STYLE="CURSOR: POINTER; background-color:  #94DAF0;"> 
								<td style="width: ">${n.noteNo}</td> 
								<td>${n.noteTitle}</td>
								<td>${n.noteId}</td>
							</tr>
					</c:forEach> 
...
//         $(".nav3 > .container-fluid > .navbar-nav").append(" <li><a href='#'  class='btn btn-default btn-sm'>clear <span class='glyphicon glyphicon-trash'></span></a></li>");
//     });
