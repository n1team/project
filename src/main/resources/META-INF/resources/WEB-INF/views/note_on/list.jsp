	...
	<nav class="navbar nav3">
	  <div class="container-fluid">
		    <ul class="nav navbar-nav nav2">
			      <li><a href="/note/list2" id="newnote" class="btn btn-default btn-sm">note <span class="glyphicon glyphicon-plus "></span></a></li>
...
<%-- 						<input id="msg" type="text" class="form-control"  value="${note.noteTitle}"> --%>
					<form:input path="noteTitle" class="form-control"  value="${note.noteTitle}"/>
