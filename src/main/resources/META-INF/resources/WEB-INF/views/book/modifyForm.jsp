...
<form:form action="/book/modify?pageNo=${param.pageNo}" method="post" modelAttribute="bookForm" class="form-horizontal">
	<form:errors/>
	<!-- bookCode -->
	...
	<input type="submit" class="btn btn-default" value="Book 정보 수정">
</form:form>
</div>
</body>
</html>